...
try {
    ...
    if (mysqli_num_rows($result) === 0) {
        throw new Exception("Message not found or you don't have permission to view it");
    }
    ...
    if ($message['reply_to_id'] !== null) {
        ...
        mysqli_stmt_bind_param($thread_stmt, "iiii", $parent_id, $parent_id, $user_id, $user_id);
        ...
        mysqli_stmt_bind_param($replies_stmt, "iii", $message_id, $user_id, $user_id);
